...
import com.edgareldy.springjdbctutorial.ws.controller.OrderController;
...
/**
 * Shared test context of the order controller tests: MVC, the REAL SecurityConfig (JWT filter, method security
 * with CustomPermissionEvaluator, 401/403 handlers), the real controller and advice, and a Mockito mock in place
 * of OrderService (no database).
 * <p>
...
public class OrderMvcTestConfig implements WebMvcConfigurer {
