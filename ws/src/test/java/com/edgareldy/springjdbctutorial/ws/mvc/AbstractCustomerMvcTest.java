...
/**
 * Common base of the customer controller tests: builds MockMvc on the shared CustomerMvcTestConfig context, resets
...
@SpringJUnitWebConfig(CustomerMvcTestConfig.class)
abstract class AbstractCustomerMvcTest {
    ...
    @BeforeEach
    void setUpMockMvc() {
        reset(customerService, authService);
